...
const textLink =
  "inline-flex h-10 items-center gap-2 rounded-xl px-3 text-[15px] font-medium text-foreground/90 transition hover:bg-black/5 hover:text-foreground";

const iconLink =
  "relative inline-flex h-10 w-10 items-center justify-center rounded-xl text-foreground/90 transition hover:bg-black/5 hover:text-foreground";
    ...
    <header className={headerClass}>
      <div className={shell}>
        <Link to={"/"} className={brandWrap}>
          ...
          <span className={brandTitle}>Trend-Wave</span>
        </Link>
            ...
            <DropdownMenu>
              ...
              >
                <DropdownMenuItem asChild>
                  <Link to={"/profile"} className={dropdownItemLink}>
